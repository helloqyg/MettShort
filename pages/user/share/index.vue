		...
		<view class="main_content">
			...
			<view class="menu_card">
				...
				<view class="item active" @click="$store.state.user.token && jumpView('/pages/user/share/poster')">
					<view class="photo">
						<image class="image" src="/static/icons/share_1.png" mode="aspectFill"></image>
					</view>
				...
				<view class="item" @click="jumpView('/pages/user/share/team')">
					<view class="photo">
						<image class="image" src="/static/icons/share_2.png" mode="aspectFill"></image>
					</view>
					<view class="text">团队管理</view>
				</view>
				<view class="item" @click="jumpView('/pages/user/share/brokerage')">
					<view class="photo">
						<image class="image" src="/static/icons/share_3.png" mode="aspectFill"></image>
					</view>
	...
	.page_content {
		.main_content {
			...
			.top_card {
				...
				&.level1 {
					background-image: url('https://mettgpt.nymaite.cn/uploads/20230525/5499e6003b7adbf4668042990ee1b73a.png');
				...
				&.level2 {
					background-image: url('https://mettgpt.nymaite.cn/uploads/20230525/94e0e94ad23da7feb5ab17b6dd193e1c.png');
				...
				&.level3 {
					background-image: url('https://mettgpt.nymaite.cn/uploads/20230525/53423acab00ab81e1ad240e31cce827b.png');
